  ...
  return (
    <div className="min-h-screen flex flex-col font-jakarta relative z-10 selection:bg-ai-gold selection:text-white">
      ...
      <main className="flex-1 flex flex-col justify-end px-8 lg:px-16 pb-12 lg:pb-20 overflow-hidden">
        <div className="max-w-[70%] lg:max-w-[65%] mt-auto">
          <h1 className="text-[#a8824f] text-[clamp(1.5rem,4.5vw,76px)] flex flex-col items-start w-full font-bold leading-[1.05] tracking-[-0.02em] mb-12">
            <span className="whitespace-nowrap">{t.hero.headlinePart1}</span>
            <span className="whitespace-nowrap">{t.hero.headlinePart2}</span>
          </h1>
